...
import info.ejava.examples.app.gesture.client.config.ClientITTestConfiguration;

/**
 * This class is an example of an integration test that uses full HTTP
 * communications and a convenient client command wrapper using WebClient
 * command for all classes: mvn verify -Pfailsafe
 * command for single class: mvn -Dit=GesturesSyncWebClientIT verify
 */
@SpringBootTest(classes = {ClientITTestConfiguration.class},
        webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("test")
@Tag("springboot")
@DisplayName("Gestures Remote WebClient IT")
@Slf4j
